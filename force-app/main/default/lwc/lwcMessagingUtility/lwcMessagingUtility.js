...
export default class LwcMessagingUtility extends LightningElement {
    ...
    clickBody(){
        ...
        console.log('click');
        const closeEvent = new CustomEvent('bodyclick');
        this.dispatchEvent(closeEvent);
    ...
    get alertMessageClass(){
        ...
        switch (this.messageVariant) {
            case 'blank':
                return 'slds-notify slds-notify_alert slds-theme_alert-texture slds-theme_blankBackground dark-color';
            case 'info':
    ...
    get inlineMessageClass(){
        ...
        switch (this.messageVariant) {
            case 'blank':
                return 'slds-box slds-m-bottom--medium slds-theme_blankBackground slds-theme_alert-texture';
            case 'info':
    ...
    get promptMessageClass(){
        ...
        switch (this.messageVariant) {
            case 'blank':
                return 'slds-modal__header slds-theme_blankBackground slds-theme_alert-texture';
            case 'info':
